...
var ftps = new FTPS({
  host: 'localhots', // required 
  username: 'zhengyutian', // Optional. Use empty username for anonymous access. 
  password: 'appleP@ssw0rd', // Required if username is not empty, except when requiresPassword: false 
